            ...
            <div class="card col form-card info-panel " style="width: 35%">
                <div class="card-body">
                    <div class="card-section">
                        ...
                        <div class="thumbnail">
                            <img id="PatientPhotoPathInput"/>
                        </div>
                        <div class="details"  id="PatientNameInput" ></div>
                        <div class="details" id="PatientAgeInput"></div>
                        <div class="details" id="PatientAddressInput"></div>
                        <div class="details" id="PatientGuardianInput"></div>
                        <div class="details" id="PatientDependentInput"></div>
                    </div>
...
function generateChart(chartID, seriesName, seriesLabel, chartData, pointColor,seriesTooltip,currentSeriesTooltip, yAxisBounds, chartType, refresh = false, multiaxis = false){
...
// 
        ...
        // }
            ...
            var rangeDataItem = yAxes[0].makeDataItem({
                    value: yAxisBounds[0][1]
                });

                var range = yAxes[0].createAxisRange(rangeDataItem);
        ...
        if(chartType == "Column"){
            for(var i = 0; i < seriesName.length; i++){
                ...
                var newpointColor = pointColor[i]
                series.columns.template.setAll({
                    templateField: newpointColor,
                    strokeWidth: 2,
